...
export const boats: Boat[] = [
  ...
  },
  {
    ...
    features: ['5.41m length', 'Cargo / technical reinforced deck', 'Oversized tube diameter'],
  ...
  },
  {
    ...
    features: ['5.81m length', 'Precision hydrodynamic strakes', 'Professional high-speed'],
  ...
  },
  {
    ...
    features: ['6.21m length', 'Long-range offshore autonomy', 'Professional crew & equipment'],
