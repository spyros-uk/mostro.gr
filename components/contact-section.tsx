...
export function ContactSection() {
  ...
  const addressLine1 = t('contactAddress.addressLine1', {
    defaultValue: SITE_CONTACT.addressLine1,
  });
  const addressLine2 = t('contactAddress.addressLine2', {
    defaultValue: SITE_CONTACT.addressLine2,
  });
  const hoursSummary = t('contactAddress.hoursSummary', {
    defaultValue: SITE_CONTACT.hoursSummary,
  });
        ...
        <div className="grid lg:grid-cols-5 gap-12 max-w-6xl mx-auto">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t('contact.openingHours')}</p>
                <p className="font-medium text-foreground">{hoursSummary}</p>
            ...
            <div className="pt-6 border-t border-border">
              <p className="text-sm font-medium text-foreground mb-3">{t('contact.followUs')}</p>
              <div className="flex gap-3">
                ...
                >
                  ...
                  <span className="sr-only">{t('contact.instagramSr')}</span>
                </a>
                <a
                ...
                >
                  ...
                  <span className="sr-only">{t('contact.facebookSr')}</span>
                </a>
              </div>
            </div>
          </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="boat">{t('contact.interestedIn')}</Label>
                      <Select>
                        ...
                        <SelectContent>
                          ...
                          {boats.map((boat) => (
                            <SelectItem key={boat.id} value={boat.id}>
                              {t(`boats.${boat.id}.name`, { defaultValue: boat.name })} ({boat.length}m)
                            </SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
